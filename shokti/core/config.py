...
class MCQConfig:
    ...
    GENERATED_RATIO: float = 0.25
    WEAK_TOPIC_RATIO: float = 0.25
    FRESH_GENERATED_RATIO: float = 0.25
    ENABLE_FRESH_GENERATION_IN_PRACTICE: bool = True
    FRESH_GENERATION_MAX_WAIT_SECONDS: int = 120
    ENABLE_GENERATION_ON_SELECTION: bool = True
    ENABLE_GEMINI_GENERATION_FOR_EXAMS: bool = True
    ENABLE_GEMINI_GENERATION_FOR_MOCK_TEST: bool = False
    ENABLE_GEMINI_GENERATION_FOR_FIXED_EXAMS: bool = False
